    ...
    <div class="form-wrap">
        <form class="login">
            ...
            <div class="sign-in-options">
                <button class="authenticator" v-on:click.prevent="signInWithProvider('google')"><google class="icon"/>Sign in with Google</button>
                <button class="authenticator" v-on:click.prevent="signInWithProvider('facebook')"><facebook class="icon"/>Sign in with Facebook</button>
                <button class="authenticator" v-on:click.prevent="signInWithProvider('twitter')"><twitter class="icon"/>Sign in with Twitter</button>
            </div>
            ...
            .catch((err) => {
                if(err.code === 'auth/account-exists-with-different-credential') {
                    ...
                    firebase.auth().fetchSignInMethodsForEmail(email).then((methods) => {
                        ...
                        window.confirm("You already have an account with " + provider.providerId + ". Do you want to login with " + provider.providerId + " instead?");
